<template>
  <div class="app-container" id="express">
    <p class="page-title">快递公司列表</p>
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="addExpress()"
        >添加快递公司</el-button
      >
    </div>
    <div class="flex-box">
    ...
    <el-dialog :visible.sync="showDialog" title="添加快递公司" width="25%">
      <el-form
        :model="form"
        status-icon
        label-width="120px"
      ...
      >
        ...
        <el-form-item label="快递公司电话" prop="tel">
          <el-input v-model="form.tel"></el-input>
        </el-form-item>
        <el-form-item label="快递公司地址" prop="address">
          <el-input v-model="form.address"></el-input>
        </el-form-item>
        <el-form-item label="联系人/收件员" prop="contact">
...
export default {
  ...
  data() {
    return {
      ...
      formRule: {
        name: [{ required: true, message: "快递公司必填", trigger: "blur" }],
      },
    };
  },
  created() {

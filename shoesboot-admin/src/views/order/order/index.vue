<template>
  <div class="app-container" id="order">
    ...
    >
      ...
      <el-table-column label="用户" prop="uid" align="center">
      </el-table-column>
      <el-table-column label="货物金额" prop="money" align="center">
      </el-table-column>
      <el-table-column label="邮费" prop="postage" align="center">
      </el-table-column>
      <el-table-column label="总金额" prop="amount" align="center">
      </el-table-column>
      <el-table-column label="优惠金额" prop="reduce" align="center">
      </el-table-column>
      <el-table-column label="支付金额" prop="payment" align="center">
      </el-table-column>
      <el-table-column label="添加订单时间" prop="add_date" align="center">
      </el-table-column>
      <el-table-column label="支付订单时间" prop="pay_date" align="center">
      </el-table-column>
      <el-table-column label="订单状态" prop="status" align="center">
        <template slot-scope="scope">
          <el-tag type="danger" v-if="scope.row.status == -1">取消</el-tag>

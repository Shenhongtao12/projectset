<template>
  <div class="app-container" id="order-detail">
    <el-row>
      <el-col :span="18" class="order-left">
        <div class="box-container">
          <el-steps :active="order.status + 2" align-center>
          ...
          <div class="product">
            <p
              style="border-bottom: 1px dashed #ccc; padding: 10px; color: #ccc"
            >
              商品列表
            </p>
            <div class="product-container">
              ...
              >
                ...
                <div class="text-container text-title">
                  ...
                  <div class="sku" v-if="pro.name_ext">
                    商品属性 : {{ pro.name_ext }}
                  </div>
                  <div class="sku" v-else>&nbsp;</div>
                </div>
                <div class="text-container text-price">
                  <div class="price">价格 : ¥{{ pro.price }}</div>
                  <div class="num">购买数量 : {{ pro.num }}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <el-col :span="6" class="order-right">
        <ul class="price">
          <li>
            <span>商品总价</span>
        ...
        <ul class="address" v-if="order.status > 1">
          <li>
            <span>快递公司</span>
        ...
        <div v-else-if="order.status == 1" class="express">
          <el-button type="success" plain @click="sendGoods()" size="mini"
            >点击发货</el-button
          >
          <el-button type="primary" plain @click="pickedUp()" size="mini"
            >自提</el-button
          >
        </div>
      </el-col>
    </el-row>
    <el-dialog :visible.sync="showDialog" title="填写发货信息" width="30%">
      <el-form
        status-icon
        label-width="120px"
        :model="expressInfo"
      ...
      >
        <el-form-item label="快递公司" prop="express">
          <el-select v-model="expressInfo.express" style="width: 100%">
            <el-option

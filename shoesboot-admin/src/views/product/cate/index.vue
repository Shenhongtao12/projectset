<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="addCate()"
        >添加分类</el-button
      >
    ...
    >
      ...
      <el-table-column align="center" label="排序(降序)" width="100px">
        <template slot-scope="scope">
          <el-input
            v-if="scope.row.edit"
            class="edit-input"

<template>
  <div class="app-container" id="product-index">
    ...
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="addGoods()"
        >添加商品</el-button
      >
    ...
    >
      <el-table-column type="expand">
        <template slot-scope="scope" v-if="scope.row.sku.length">
          <el-table
            ...
            highlight-current-row
          >
            <el-table-column prop="name" align="center" label="属性名">
            </el-table-column>
            <el-table-column prop="img" align="center" label="商品图片">
              <template slot-scope="scope">
                <div class="img-container">
                  <img :src="cdn + scope.row.img" class="img-container" />
                </div>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="sales_volume" align="center" label="售出">
            </el-table-column>
          </el-table>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="所属分类" prop="cate_id">
        <template slot-scope="scope">
          <span>{{ cate[scope.row.cate_id] }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="市场价" prop="market_price">
      </el-table-column>
      <el-table-column align="center" label="售价" prop="price">
      </el-table-column>
      <el-table-column align="center" label="库存" width="80px" prop="stock">
      </el-table-column>
      <el-table-column
        align="center"
        label="销量"

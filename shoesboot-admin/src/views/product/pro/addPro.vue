<template>
  <div class="app-container" id="add-pro">
    <el-form
    ...
    >
      <el-row>
        <el-col :span="24" style="margin-bottom: 22px">
          <el-form-item prop="title" id="title-item">
            <MDinput :maxlength="25" v-model="formValue.title"
              >输入标题</MDinput
            >
          </el-form-item>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="8" v-if="!haveSku">
          <el-form-item label="库存" prop="stock">
            <el-input
              style="width: 200px"
              type="number"
              v-model.number="formValue.stock"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8" v-if="!haveSku">
          <el-form-item label="市场价" prop="market_price">
            <el-input
              style="width: 200px"
              type="number"
              v-model.number="formValue.market_price"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" v-if="!haveSku">
        ...
        <el-col :span="8" v-if="!haveSku">
          <el-form-item label="售出" prop="sales_volume">
            <el-input
              style="width: 200px"
              type="number"
              v-model.number="formValue.sales_volume"
            ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-if="skuLabel.length > 0">
        ...
        >
          <span class="diver"
            >选择商品属性1
            <div class="el-form-item__error" v-if="choose1Error">
              请继续选择属性2
            </div>
          </span>
          <el-checkbox
        ...
        >
          <span class="diver"
            >选择商品属性2
            <div class="el-form-item__error" v-if="choose2Error">
              请继续选择属性1
            </div>
          </span>
          <el-checkbox
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="是否上架" prop="is_hot">
            <el-radio v-model.number="formValue.is_hot" :label="1" border
              >上架</el-radio
            >
            <el-radio v-model.number="formValue.is_hot" :label="0" border
              >下架</el-radio
            >
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="是否热卖" prop="status">
            <el-radio v-model.number="formValue.status" :label="1" border
              >是</el-radio
            >
            <el-radio v-model.number="formValue.status" :label="0" border
              >否</el-radio
            >
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <el-input
                  v-model.number="scope.row.sales_volume"
                  type="number"
                  size="mini"
                ></el-input>
              </template>
            ...
            <el-table-column prop="sales_volume" align="center" label="操作">
              <template slot-scope="scope">
                <el-button
                  type="warning"
...
export default {
  ...
  methods: {
    ...
    handleRemove(file, fileList) {
      this.formValue.imgs.splice(
        inArray(this.formValue.imgs, file.response.data),
        1
      );
    ...
    overwrite(h, { column, $index }) {
      return (
        <el-popover placement="top-start" trigger="click">
          <el-row>
            <el-col span={15}>
              <el-input
                size="mini"
                on-change={(str) => {
                  this.skuAttr[column.property] = str;
                }}
                placeholder="全部修改"
              ></el-input>
            </el-col>
          ...
          <span slot="reference" style="display: flex; justify-content:center">
            {column.label}

<template>
  <div class="app-container" id="edit-pro">
    <el-form
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="8" v-if="formValue.sku.length == 0">
        ...
        .then((res) => {
          ...
          getCate().then((res) => {
            ...
            if (this.formValue.sku.length > 0) {
              ...
              this.formValue.sku.forEach((item) => {
                if (item.sku_id_1 > 0) {
                  !attr1_id[item.sku_id_1]
                    ? (attr1_id[item.sku_id_1] = item.sku_id_1)
                    : "";
                }
                if (item.sku_id_2 > 0) {
                  !attr2_id[item.sku_id_2]
                    ? (attr2_id[item.sku_id_2] = item.sku_id_2)
                    : "";
                }
              });

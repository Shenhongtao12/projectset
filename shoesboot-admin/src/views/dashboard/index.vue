<template>
  <div class="dashboard-container">
    <el-row>
      <el-col :span="12" style="height: 300px" id="member"> </el-col>
      <el-col :span="12" id="sales" style="height: 300px"> </el-col>
    </el-row>
    <el-row class="enter-container">
      <el-col :span="6">
        <div class="enter" @click="gotoUrl('/member/index')">
          <div class="img">
      ...
      <el-col :span="6">
        <div class="enter" @click="gotoUrl('/system/database')">
          <div class="img">

<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="handelAdd()"
        >添加推荐内容</el-button
      >
    ...
    >
      ...
      <el-table-column align="center" prop="pinfo.name" label="所属分类">
      </el-table-column>
      <el-table-column align="center" prop="name" label="推荐信息">
      </el-table-column>
      <el-table-column align="center" prop="memo" label="推荐摘要">
      </el-table-column>
      ...
      <el-table-column align="center" prop="sort" width="60px" label="排序">
      </el-table-column>
    ...
    <el-dialog :visible.sync="showDialog" title="添加推荐位内容" width="30%">
      <el-form
        :model="form"
        status-icon
        label-width="120px"
      ...
      >
        ...
        <el-form-item label="推荐信息" prop="name">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="推荐摘要" prop="memo">
          <el-input v-model="form.memo"></el-input>
        </el-form-item>
        <el-form-item label="推荐链接" prop="link">
        ...
        <el-form-item label="推荐图片">
          <el-upload
            ...
            :action="imgPostUrl"
          >
            <el-button slot="trigger" v-if="!form.img" type="primary"
              >选取文件</el-button
            >
            <img
              :src="cdn + form.img"
...
export default {
  ...
  data() {
    return {
      ...
      isAdd: true,
      formRule: {
        name: [{ required: true, message: "请输入推荐信息", trigger: "blur" }],
        // memo: [

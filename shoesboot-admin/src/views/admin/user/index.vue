<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="addAdmin()"
        >添加管理员</el-button
      >
    ...
    >
      ...
      <el-table-column align="center" label="管理员名称" prop="user_name">
      </el-table-column>
      <el-table-column align="center" label="管理员真实姓名" prop="real_name">
      </el-table-column>
      <el-table-column align="center" label="管理员角色" prop="role.role_name">
      </el-table-column>
      <el-table-column align="center" label="最后登录IP" prop="last_login_ip">
      </el-table-column>
      <el-table-column
        align="center"
        label="最后登录时间"

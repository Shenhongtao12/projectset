<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="append('')"
        >添加顶级节点</el-button
      >
    </div>
    <el-tree
      style="width: 40%; margin: 50px 0 0 80px"
      :data="tree"
      node-key="id"
      ...
      >
        ...
        <el-form-item>
          <div style="float: right">
            ...
            <el-button type="success" @click="showDialog = false"
              >取消</el-button
            >
          </div>
        </el-form-item>
          ...
          <span class="operation">
            <div>
              <el-button
                ...
                type="text"
                style="color:#409EFF"
                on-click={() => this.append(node, data, 1)}
              >
                编辑该节点
              </el-button>
              <el-button
                ...
                type="text"
                style="color:#67c23a"
                on-click={() => this.append(node, data, 2)}
              >
                添加子节点
              </el-button>
              <el-button
